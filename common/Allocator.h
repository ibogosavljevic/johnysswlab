...
class MemoryPool
{
    ...
    public:
        ...
        MemoryPool(MemoryPool &&memoryPool) {
            firstFreeBlock = memoryPool.firstFreeBlock;
            firstBuffer = memoryPool.firstBuffer;
            bufferedBlocks = memoryPool.bufferedBlocks;

            memoryPool.firstBuffer = nullptr;
            memoryPool.firstFreeBlock = nullptr;
            memoryPool.bufferedBlocks = growSize;
        }
