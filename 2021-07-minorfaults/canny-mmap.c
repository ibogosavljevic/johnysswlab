         ...
         float tlow, float thigh, unsigned char **edge, char *fname)
{
   ...
   ****************************************************************************/
   ...
   if((nms = (unsigned char *) malloc_large(rows*cols*sizeof(unsigned char)))==NULL){
   ...
   ****************************************************************************/
   ...
   if((*edge=(unsigned char *)malloc_large(rows*cols*sizeof(unsigned char))) ==NULL){
   ...
   ****************************************************************************/
   free_large(smoothedim, rows*cols*sizeof(short));
   free_large(delta_x, rows*cols*sizeof(short));
   free_large(delta_y, rows*cols*sizeof(short));
   free(magnitude);
   free_large(nms, rows*cols*sizeof(unsigned char));
}
        ...
        short int **delta_x, short int **delta_y)
{
   ...
   ****************************************************************************/
   if(((*delta_x) = (short *) malloc_large(rows*cols* sizeof(short))) == NULL){
      fprintf(stderr, "Error allocating the delta_x image.\n");
      exit(1);
   }
   if(((*delta_y) = (short *) malloc_large(rows*cols* sizeof(short))) == NULL){
      fprintf(stderr, "Error allocating the delta_x image.\n");
      exit(1);
   }
        ...
        short int **smoothedim)
{
   ...
   ****************************************************************************/
   if((tempim = (float *) malloc_large(rows*cols* sizeof(float))) == NULL){
      fprintf(stderr, "Error allocating the buffer image.\n");
      exit(1);
   }
   if(((*smoothedim) = (short int *) malloc_large(rows*cols*
